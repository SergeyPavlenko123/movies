...
})({"8FttR":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "fea4818e231661c6";
"use strict";
...
},{}],"2b7na":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _api = require("./api");
var _apiDefault = parcelHelpers.interopDefault(_api);
var _libraryList = require("../templates/library-list");
...
const showLibrary = async (key)=>{
    ...
    moviesWrap.innerHTML = (0, _libraryListDefault.default)(moviesArr);
};
...
},{"./api":"csPsJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../templates/library-list":"9yCm2"}],"csPsJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class ApiService {
    ...
    async getSearchResult(searchString) {
        ...
        const res = await fetch(`${this.baseUrl}/search/movie?query=${this.searchString}&${this.params}${this.page}`);
        const data = await res.json();
        return data;
    }
}
...
},{}],"9yCm2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = moviesList = (arr)=>{
    let template = "";
    arr.forEach((element)=>{
        let { title, poster_path, genres, release_date, vote_average, id } = element;
        template += `<li class="movie-list-card" data-bs-toggle="modal" data-bs-target="#exampleModal">
                     <img class="movie-list-img" src="https://image.tmdb.org/t/p/w342${poster_path}" alt="movie picture" data-id=${id}>
                      ...
                      <div class="card-list">
                           <p class="movie-card-category">${genres.map(({ name })=>name).join(", ")} | ${release_date}"</p>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8FttR","2b7na"], "2b7na", "parcelRequire20dd")

//# sourceMappingURL=library-page.231661c6.js.map
