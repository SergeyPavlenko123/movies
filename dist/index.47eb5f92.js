...
const renderMovies = (movies)=>{
    movies.length == 0 ? moviesWrap.innerHTML = `<h2 class="no-result">\u{41D}\u{456}\u{447}\u{43E}\u{433}\u{43E} \u{43D}\u{435} \u{437}\u{43D}\u{430}\u{439}\u{434}\u{435}\u{43D}\u{43E}</h2>` : moviesWrap.innerHTML = (0, _moviesListDefault.default)(movies);
};
// -------------------------------------------
...
const onSearchInput = (e)=>{
    if (searchInput.value.length > 2) Promise.all([
